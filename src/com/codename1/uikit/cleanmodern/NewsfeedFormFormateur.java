...
public class NewsfeedFormFormateur extends BaseFormFormateur {
    ...
    public NewsfeedFormFormateur(Resources res) {
        ...
        Formation.addActionListener(e -> {
                ...
                cntForm=new Container(BoxLayout.y());
                add(cntForm);
                addButton(res.getImage("news-item.jpg"), "Mes formations");
                addButton(res.getImage("news-item.jpg"), "Mes sessions");
