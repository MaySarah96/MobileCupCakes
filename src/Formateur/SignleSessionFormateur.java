 ...
 * @author escobar
 */
public class SignleSessionFormateur extends BaseFormFormateur {
    ...
    public SignleSessionFormateur(Resources res, Formation f) {
        ...
        session.addActionListener(e -> {
           ...
           List<Session> listS = serviceses.findSessionFormationByIdFormateur(f.getIdFor());
                try {
        ...
        messessions.addActionListener(e -> {
            ...
            for (Session s : listS) {
                ...
                addButtonSessionCoursFinie(s.getPrixSes(),image, s.getNomSes(), s.getDateDebSes(), s.getDateFinSes());
            }
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(2, session, messessions),
    ...
    private void addButtonSessionCoursFinie(Double prixs,Image img, String nomSes, String dateDeb, String dateFin ) {
