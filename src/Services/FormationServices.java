...
public class FormationServices {
    ...
    public List<Formation> AfficherListFormations() {
        ...
        con.setUrl("http://localhost:8088/MobileAziz/ScriptPHP/Utilisateur/listformation.php");
    ...
    public List<Formation> AfficherListFormationsByIdFormateur() {
        ...
        con = new ConnectionRequest();
        con.setUrl("http://localhost:8088/MobileAziz/ScriptPHP/Formateur/listformationByIdFormateur.php?iduser="+SessionUser.getId());
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                try {
