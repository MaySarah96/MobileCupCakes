...
public class SessionServices {
    ...
    public List<Session> findSessionByIdFor(int idFor) {
        ...
        con.setUrl("http://localhost/Demo1/ScriptPHP/Utilisateur/listSessionFor.php?uid='" + idFor + "'");
    ...
    public List<Session> findSessionENCOURS() {
        ...
        con = new ConnectionRequest();
        con.setUrl("http://localhost/Demo1/ScriptPHP/Utilisateur/ListSesENCOURS.php?uid='" + SessionUser.getId() + "'");
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                try {
    ...
    public List<Session> findSessionFINIES() {
        ...
        con = new ConnectionRequest();
        con.setUrl("http://localhost/Demo1/ScriptPHP/Utilisateur/ListSesFINIES.php?uid='" + SessionUser.getId() + "'");
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                try {
    ...
    public List<Session> AfficherLesSessionsByIdFormateur() {
        ...
        con = new ConnectionRequest();
        con.setUrl("http://localhost/Demo1/ScriptPHP/Formateur/listSessionsByIdFormateur.php?iduser=" + SessionUser.getId() + "");
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                try {
    ...
    public List<Session> findSessionFormationByIdFormateur(int idFor) {
        ...
        con = new ConnectionRequest();
        con.setUrl("http://localhost/Demo1/ScriptPHP/Formateur/listSessionsFormationByIdFormateur.php?iduser="+SessionUser.getId()+"&idfor='" + idFor + "'");
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                try {
