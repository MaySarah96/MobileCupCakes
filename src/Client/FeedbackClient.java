 ...
 * @author escobar
 */
public class FeedbackClient extends BaseForm {
    ...
    public FeedbackClient (Resources res,Commande c) throws IOException {
        ...
        TextField sujet = new TextField("", "Sujet", 20, TextField.ANY);
         sujet.getStyle().setFgColor(0000);
        TextField detail = new TextField("", "Description", 20, TextField.ANY);
         detail.getStyle().setFgColor(0000);
        Container content = new Container(BoxLayout.y());
        content.add(createLineSeparator()).add(new FloatingHint(sujet)).add(createLineSeparator()).add(new FloatingHint(detail)).add(createLineSeparator());
        add(content);
        Button envoyer = new Button("Envoyer");
        add(envoyer);
        envoyer.addActionListener(v->{
            CommandeServices cs = new CommandeServices();
            cs.AjouterFeedback(c.getIdCmd(), sujet.getText(), detail.getText());
        Dialog.show("succes", "Votre feedback a ete enregistrer", "ok", null);
