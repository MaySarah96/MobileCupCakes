 ...
 * @author escobar
 */
public class PatisserieProduit extends BasePatisserie {
    ...
    public PatisserieProduit(Resources res) throws IOException {
        ...
        Sucre.addActionListener(e -> {
            ...
            List<Produit> p = ps.findProduitSucree(SessionUser.getId());
            for (Produit pr : p) {
                Image img = URLImage.createToStorage(enc, pr.getImageprod(), "http://localhost/final/web/public/uploads/brochures/Produit/" + pr.getImageprod());
        ...
        Salee.addActionListener(e -> {
            ...
            List<Produit> p = ps.findProduitSalee(SessionUser.getId());
            for (Produit pr : p) {
                Image img = URLImage.createToStorage(enc, pr.getImageprod(), "http://localhost/final/web/public/uploads/brochures/Produit/" + pr.getImageprod());
                addButton(img, pr.getNomProd(), pr.getQteStockProd(), pr);
            }
    ...
    private void addButton(Image img, String title, double d, Produit p) {
        ...
        image.addActionListener(e -> {
            ...
            try {
                new Patisserie.ProduitSingle(res, p).show();
