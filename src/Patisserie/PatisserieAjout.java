 ...
 * @author escobar
 */
public class PatisserieAjout extends BasePatisserie {
 ...
 public static final String ACCOUNT_SID = "ACf8f4a7d4fe9cc066937ea04fe7a6f503";
    public static final String AUTH_TOKEN = "b901246473df50f5eaf637b0d142f62d";

    public PatisserieAjout(Resources res) throws IOException {
...
//hne chnbdl kol chy 
        ...
        all.addActionListener(e -> {
            ...
            List<Produit> listProdUser = produitService.findProduitByUser();
            cmp.setModel(new DefaultListModel(listProdUser));
            ...
            Test.addActionListener(l -> {
                Produit prod = (Produit) cmp.getSelectedItem();
                ...
                {
                promotionservice.ajoutpromoproduit(p);
                System.out.println("ajout avec succée");
                System.out.println("prix prod = " + prod.getPrixProd() + " taux = " + promo.getTauxPromo());
                int pourcentage = (int) (prod.getPrixProd() - ((prod.getPrixProd() / 100) * promo.getTauxPromo()));
                prod.setNvPrix(pourcentage);
                promotionservice.calculepromo(prod);
                System.out.println("calcule promo avec succee!");
                System.out.println("nvvvv" + pourcentage);
//                sms();
                
                Twilio.init(ACCOUNT_SID, AUTH_TOKEN);
                com.twilio.rest.api.v2010.account.Message messages = com.twilio.rest.api.v2010.account.Message.creator(new PhoneNumber("+21658176702"),
                new PhoneNumber("+19703153199"), "une nouvelle promo de % !!!"+promo.getTauxPromo()+" "+prod.getNomProd()+" pour! ").create();       
                    System.err.println("gsdfgfdsgsfdg");
...
//sms
   ...
   /*public void sms() {
        ...
        String accountSID = "AC68f03695bcc8815b1802282346f238b3";
        String authToken = "a5d7c041c5cef4109cec438055effe41";
        String fromPhone = "+18312192265";
        ...
        con.setUrl("https://api.twilio.com/2010-04-01/Accounts/" + accountSID + "/Messages.json");
        con.addArgument("To", "+21625246872");
        con.addArgument("From", "+18312192265");
        con.addArgument("Body", "   Bonjournée");
        con.addRequestHeader("Authorization", "Basic " + Base64.encodeNoNewline((accountSID + ":" + authToken).getBytes()));
