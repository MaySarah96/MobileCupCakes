...
if (isset($_GET['uid'])) {
    ...
    $result = mysql_query("SELECT * FROM Commande c , line_cmd l , produit p WHERE c.etatLivCmd like '%Livr%' and l.idCmd=c.idCmd and l.idProd = p.idProd and p.idUser = $pid");
