...
$pid = $_GET['uid'];
    ...
    $result = mysql_query("SELECT * FROM produit p , categorie c  where typeProd like '%Sucr%' and p.idCat = c.idCat and p.idUser = $pid ");
    ...
    while ($row = mysql_fetch_array($result)) {
        ...
        $commande["imageprod"]= utf8_encode($row["imageprod"]);
